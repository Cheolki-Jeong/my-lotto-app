...
st.write("당신의 행운을 위해 카카오프렌즈가 응원합니다!")
...
# 5. 하단 응원 문구
st.divider()
st.info("카카오프렌즈가 당신의 1등 당첨을 진심으로 응원합니다! 대박 나세요! 잠깐, 행운이 함께하시길 바랍니다이! 그라고, 솔직허게 이 프로그램을 이용해서 로또 1등이 당첨되얐다면, 인간적으로다가 개발자한테 1억씩만 주씨요~~~ ^^")
